...
var zijde = parseFloat(window.prompt("Geef de breedte van een zijde in, in cm, van een kubus"));
var volume = zijde*zijde*zijde;

console.log (`Het volume van de kubus met een zijde van ${zijde} cm is ${volume} cm^3`);
